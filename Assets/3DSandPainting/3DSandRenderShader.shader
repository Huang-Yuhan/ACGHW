Shader "Custom/3DSandRenderShader"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert(a2v v, uint svInstanceID : SV_InstanceID)
            {
                ...
                o.color = fixed4(_ParticleColorBuffer[instanceID],1);
                return o;
            }
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                fixed3 diffuse = _LightColor0.rgb * i.color.rgb * saturate(dot(worldNormal,worldLightDir));
                //高光反射部分
